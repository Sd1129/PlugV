        ...
        <div className="mx-auto grid w-full max-w-7xl gap-5 px-4 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-6 sm:p-8">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-6 text-slate-300">
              ...
              <li>Most recent recorded station check in this dataset: <strong>{chargingDataLastVerified}</strong>.</li>
...
function StationCard({ station }: { station: NearbyStation }) {
  ...
  return (
    <article className="rounded-[1.75rem] border border-white/10 bg-white/[0.04] p-5 transition hover:-translate-y-0.5 hover:border-sky-300/25 hover:bg-white/[0.06]">
      ...
      <StationDataNote station={station} /><div className="mt-3"><ChargerConfidenceBadge confidence={confidence} /></div>
