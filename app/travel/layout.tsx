...
export const metadata: Metadata = {
  ...pageSocialMetadata("EV Trip Planner India — Route, Range & Charging Stops", "Plan electric-car trips across India with route distance, duration, compatible chargers and practical charging-stop guidance.", "/travel"),
