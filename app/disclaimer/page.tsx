...
export default function DisclaimerPage() {
  return <LegalPage eyebrow="Important information" title="Disclaimer" summary="PlugV is designed to reduce EV confusion, but important vehicle, charging and travel decisions must still be confirmed with the responsible manufacturer or operator.">
    <p><strong>Effective date:</strong> 21 August 2026 · <strong>Last updated:</strong> 8 September 2026</p>
    <h2 id="data-clarity">PlugV data clarity</h2><p>PlugV separates official or manufacturer-claimed information from planning estimates, unverified fields and live information received from approved sources. Prices are generally ex-showroom and must be confirmed with the manufacturer or dealer. Range figures are manufacturer-claimed unless a practical estimate is explicitly labelled. Comparison results may combine verified inputs with clearly identified estimates. A listed charger is not guaranteed to be operational, available, compatible or free; live status is shown only when supplied by an operator feed. Travel routes, journey times, charging stops and arrival charge are planning estimates. Saved trips, chargers and device reminders normally remain in the user&apos;s browser, while email reminders are stored only following verification and consent.</p><p>For detailed sourcing and review practices, see PlugV&apos;s <a href="/methodology">data methodology</a>.</p>
