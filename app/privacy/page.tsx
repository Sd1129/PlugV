...
export default function PrivacyPage() {
  return <LegalPage eyebrow="Your privacy" title="Privacy Policy" summary="This policy explains what information PlugV may process, why it is used, and the choices available to you when using plugv.in.">
    ...
    <h2>3. Information stored on your device</h2><p>My EV reminders, saved trips, saved chargers and alert preferences are currently stored in your browser using local storage. They are not synchronised to a PlugV account in this release. Clearing browser data may permanently remove them.</p>
