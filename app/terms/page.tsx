...
export default function TermsPage() {
  return <LegalPage eyebrow="Using PlugV" title="Terms of Use" summary="These terms govern access to PlugV.in. By using the platform, you agree to use it responsibly and to verify important decisions with the relevant manufacturer, operator or professional.">
    ...
    <h2>Operator</h2><p>PlugV is operated by Syed Manjoor Ahmed, trading under the name PlugV, from Sun City, Bandlaguda Jagir, Hyderabad, Telangana, India.</p>
    ...
    <h2>10. Governing law</h2><p>These terms are governed by the laws of India. Subject to mandatory consumer-protection rights and any jurisdiction that cannot lawfully be excluded, disputes will be subject to the competent courts at Hyderabad, Telangana.</p>
    <h2>11. Contact and notices</h2><p>Questions or notices about these terms may be sent to <a href="mailto:support@plugv.in?subject=Terms%20of%20Use">support@plugv.in</a> or addressed to PlugV, Sun City, Bandlaguda Jagir, Hyderabad, Telangana, India.</p>
  </LegalPage>;
}
