...
export const vehicleTripProfiles: Record<string, VehicleTripProfile> = {
  ...
  "hyundai-creta-electric": {
    ...
    variants: [
      { name: "42 kWh", batteryCapacityKWh: 42, certifiedRangeKm: 420, practicalRangeKm: 336, maxDcChargeKW: 50, maxAcChargeKW: 11, connector: "CCS2", fastChargeFromPercent: 10, fastChargeToPercent: 80, fastChargeMinutes: 58 },
      { name: "Long Range 51.4 kWh", batteryCapacityKWh: 51.4, certifiedRangeKm: 510, practicalRangeKm: 408, maxDcChargeKW: 50, maxAcChargeKW: 11, connector: "CCS2", fastChargeFromPercent: 10, fastChargeToPercent: 80, fastChargeMinutes: 58 },
    ],
